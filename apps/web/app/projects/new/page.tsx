      ...
      <div className="container hero-grid">
        <div>
          ...
          <p className="hero-copy">
            Create a project shell, upload a PNG, JPG, SVG, or PDF floor plan,
            then confirm the editable trace. The sample flat remains the
            reliable fallback.
          </p>
          <div className="button-row">
            <Link
              className="button button-primary"
              href="/projects/demo-london-flat/upload"
            >
        ...
        <div className="grid gap-4">
          ...
          <div className="card">
            ...
            <p>
              RenovationTwin does not provide architectural, structural,
              planning permission, or contractor-grade measurement advice.
            </p>
          </div>
        </div>
      </div>
